<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="TeacherSubject.aspx.cs" Inherits="SchoolSystem.Admin.TeacherSubject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container p-md-4 p-sm-4">
        ...
        <div class="row mb-3 m-lg-5 ml-lg-5">
            <div class="col-md-10">
                <asp:GridView ID="GVToShowTeacherSubjects" runat="server" CssClass="table table-hover table-bordered" AllowPaging="True" AutoGenerateColumns="False" PageSize="6" EmptyDataText="No recordes to display..!" DataKeyNames="TeacherSubjectID" OnPageIndexChanging="GVToShowSubjects_PageIndexChanging" OnRowCancelingEdit="GVToShowSubjects_RowCancelingEdit"  OnRowEditing="GVToShowSubjects_RowEditing" OnRowUpdating="GVToShowSubjects_RowUpdating" OnRowDeleting="GVToShowSubjects_RowDeleting" OnRowDataBound="GVToShowTeacherSubjects_RowDataBound"  >
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Teacher">
                            <EditItemTemplate>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolSystemConnectionString %>"  SelectCommand="SELECT [TeacherID], [TeacherName] FROM [Teachers]"></asp:SqlDataSource>
                            </EditItemTemplate>
                            <ItemTemplate>
